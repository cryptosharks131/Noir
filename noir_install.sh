...
COIN_REPO='https://github.com/cryptosharks131/Noir/releases/download/v2.1.0.1/noir.tar.gz'
COIN_REPO18='https://github.com/cryptosharks131/Noir/releases/download/v2.1.0.1/noir18.tar.gz'
COIN_NAME='Noir'
COIN_RPC=8822
COIN_PORT=8255
